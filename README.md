# cn-webbandongho-nhom1-express-ts
...
```bash
git clone https://github.com/organization-codeflow/cn-webbandongho-nhom1-express-ts.git
cd cn-webbandongho-nhom1-express-ts
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=cn-webbandongho-nhom1-express-ts
- Xem các metrics:
